...
pis(nanotest.nanoconf["error"], False, "no error (1)")
# tuple
pis_deeply((1, 'a', 34), (1, 'a', 34), "identical tuples")
pis(nanotest.nanoconf["error"], False, "no error (2)")
# list
pis_deeply([1, 'a', 34], [1, 'a', 34], "identical lists")
pis(nanotest.nanoconf["error"], False, "no error (3)")
# dict
pis_deeply({'a':22, 'b':"foo"}, {'a':22, 'b':"foo"}, "identical dicts")
pis(nanotest.nanoconf["error"], False, "no error (4)")
# blended
